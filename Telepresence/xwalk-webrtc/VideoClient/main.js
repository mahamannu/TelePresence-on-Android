document.addEventListener('DOMContentLoaded', function () {
  ...
  var audioSource  = 1 ;
   ...
   function gotSources(sourceInfos) {
                        ...
                        //  numOfAudioSources = numOfAudioSources + 1 ;
                ...
                if (typeof MediaStreamTrack === 'undefined'){
                          alert('The webkit in this App/Browser does not support MediaStreamTrack.\n\nTry Chrome Canary.');
                          } else {
...
constraints,
  ...
  var connect = function () {
                                                 // console.log('numOfAudioSources = ',numOfAudioSources);
                         //  var textBox = document.getElementById("myTextBox");
                           // textBox.value = numOfAudioSources ;
